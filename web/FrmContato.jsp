    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="adicionaContato">
                ...
                <div class="form-group">
                    Endereço: <input  class="form-control "type="text" name="endereco" /><br />
                </div>
                <div class="form-group">
                    Data Nascimento: <input class="form-control" type="date" name="dataNascimento" placeholder="dd/mm/yyyy" maxlength="10" onkeypress="mascaraData(this, event)"/> <br />
                </div>
